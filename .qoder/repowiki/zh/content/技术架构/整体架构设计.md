...
## 简介
本项目为“宝宝助手”微信小程序，采用微信小程序原生框架与云开发能力，构建基于 MVVM 的前后端分离架构。前端通过云开发 SDK 调用云函数，云函数作为中间层处理业务逻辑并访问云数据库，实现弹性扩展、按需付费、无需服务器维护的 Serverless 架构。系统支持多家庭、多宝宝管理，提供成长记录图表可视化与权限控制，具备良好的可扩展性与可维护性。
