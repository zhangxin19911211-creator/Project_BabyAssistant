...
## 简介
本指南面向“宝宝助手”小程序的开发者与运维人员，系统化说明开发、测试、生产三类环境的配置方法与差异；详解项目配置文件 project.config.json 的关键参数；解释 envList.js 的作用与扩展方式；说明云开发环境变量与云函数部署流程；并提供 project.private.config.json 的私有配置管理策略与环境隔离最佳实践。
